...
import {SignUser} from "../actions/userAction"
...
export default function Signup(){
    ...
    const handleSubmit=(e)=>{
     ...
     dispatch(SignUser(email,password,name));
    }
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div className="w-full">
              ...
              {nameError && <span className="text-red-700 italic text-sm">name can't be blank</span>}
              <div className="mt-4">
                <label className="block text-sm">
                  Email
                </label>
              ...
              <div class="mt-4 text-center">
                <p class="text-sm">Have an account? <a onClick={()=>navigate("/login")}
                    class="text-blue-600 hover:underline cursor-pointer"> Login</a></p>
              </div>
            </div>
          </div>
        </div>
